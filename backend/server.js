...
mongoose
  .connect(
    process.env.MONGODB_URI || "mongodb://localhost:27017/cvprofessional",
    {
...
app.post("/api/cv/generate", async (req, res) => {
  ...
  try {
    ...
    // Template HTML profissional IDÊNTICO AO PREVIEW - COM ÍCONES CORRIGIDOS
    const html = `
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        * {
        ...
        /* CORREÇÃO CRÍTICA: Substituir completamente o método do ícone */
